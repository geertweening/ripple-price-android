...
public class MainActivity extends ActionBarActivity implements ActionBar.TabListener {
    ...
    private String[] currencyDummyData = new String[] { "USD", "CNY", "EUR", "BTC", "USD", "CNY", "EUR", "BTC",  "USD", "CNY", "EUR", "BTC", "USD", "CNY", "EUR", "BTC",  "USD", "CNY", "EUR", "BTC", "USD", "CNY", "EUR", "BTC"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        convertOptions = new ArrayList<String>();
        convertOptions.add("1 XRP =");
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    ...
                    fragment.setListAdapter(new SimpleArrayAdapter(MainActivity.this, android.R.layout.simple_list_item_1, currencyDummyData));
                    return fragment;
                default:
